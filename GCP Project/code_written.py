...
delivered_table_spec = 'gcp-cloud-learn-babu:dataset_food_orders.delivered_orders'
#project-id:dataset_id.table_id
other_table_spec = 'gcp-cloud-learn-babu:dataset_food_orders.other_status_orders'

import apache_beam as beam
from apache_beam.options.pipeline_options import PipelineOptions, StandardOptions
from apache_beam.utils.pipeline_result import PipelineResult
import argparse
...
from apache_beam.utils.pipeline_result import PipelineResult
ret = p.run()
if ret.state == PipelineResult.PipelineState.DONE:
    print('Success!!!')
else:
...
view_to_create.view_query = 'select * from `gcp-cloud-learn-babu.dataset_food_orders.delivered_orders` where _PARTITIONDATE = DATE(current_date())'
