...
delivered_table_spec = 'gcp-cloud-learn-babu:dataset_food_orders_latest_dag.delivered_orders'
#project-id:dataset_id.table_id
other_table_spec = 'gcp-cloud-learn-babu:dataset_food_orders_latest_dag.other_status_orders'
...
dataset_id = "{}.dataset_food_orders_latest_dag".format(client.project)
...
dataset_ref = client.dataset('dataset_food_orders_latest_dag')
view_ref = dataset_ref.table(view_name)
view_to_create = bigquery.Table(view_ref)

view_to_create.view_query = 'select * from `gcp-cloud-learn-babu.dataset_food_orders_latest_dag.delivered_orders` where _PARTITIONDATE = DATE(current_date())'
